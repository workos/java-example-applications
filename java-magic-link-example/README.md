...
6. Add http://localhost:7001/callback as a Redirect URI in the Configuration section of the Dashboard as shown below and ensure it is set as the default:
...
7. Start the server by running this command in the CLI:
```bash
./gradlew :java-magic-link-example:run
```

8. Navigate to http://localhost:7001. Enter your email address in the text field.

9. Check your email for a new message that contains a Magic Link. Click on the Magic Link, and you’ll be redirected to a success page in the browser. 
