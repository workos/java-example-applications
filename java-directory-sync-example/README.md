...
6. Start the server by running this command in the CLI while you’re in the java-example-applications/ directory:
```bash
$ ./gradlew :java-directory-sync-example:run
```

7. Navigate to http://localhost:7001. Click the “View Directories” button. You will then see a list of Directories if any have been added to your WorkOS dashboard. If you don’t see any Directories, it’s time to [add your first one](https://workos.com/docs/directory-sync/guide)!
